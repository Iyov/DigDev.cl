...
const blogContent = {
  1: {
    es: {
      ...
      content: `
        <div class="mb-6">
          <img src="img/optimized/blog-automatizacion-800.webp" alt="Automatización minera" class="w-full h-64 object-cover rounded-lg mb-6" loading="lazy" decoding="async">
    ...
    en: {
      ...
      content: `
        <div class="mb-6">
          <img src="img/optimized/blog-automatizacion-800.webp" alt="Mining automation" class="w-full h-64 object-cover rounded-lg mb-6" loading="lazy" decoding="async">
  ...
  2: {
    es: {
      ...
      content: `
        <div class="mb-6">
          <img src="img/optimized/blog-logistica-800.webp" alt="Cadena de suministro minera" class="w-full h-64 object-cover rounded-lg mb-6" loading="lazy" decoding="async">
    ...
    en: {
      ...
      content: `
        <div class="mb-6">
          <img src="img/optimized/blog-logistica-800.webp" alt="Mining supply chain" class="w-full h-64 object-cover rounded-lg mb-6" loading="lazy" decoding="async">
  ...
  3: {
    es: {
      ...
      content: `
        <div class="mb-6">
          <img src="img/optimized/blog-futuro-800.webp" alt="Futuro de la minería" class="w-full h-64 object-cover rounded-lg mb-6" loading="lazy" decoding="async">
    ...
    en: {
      ...
      content: `
        <div class="mb-6">
          <img src="img/optimized/blog-futuro-800.webp" alt="Future of mining" class="w-full h-64 object-cover rounded-lg mb-6" loading="lazy" decoding="async">
...
function getBlogImage(blogId) {
  const images = {
    '1': 'img/optimized/blog-automatizacion-800.webp',
    '2': 'img/optimized/blog-logistica-800.webp',
    '3': 'img/optimized/blog-futuro-800.webp'
  };
  return images[blogId] || 'img/DigDev_logo.png';
}
