...
const translations = {
    'es': {
        ...
        'blog.post3.title': 'Tendencias Tecnológicas que Marcarán el 2026',
        'blog.post3.excerpt': 'Exploramos las tecnologías emergentes que están transformando el panorama digital empresarial.',
        'blog.post3.content1': 'El panorama tecnológico evoluciona a un ritmo acelerado, y 2026 promete traer innovaciones que transformarán la forma en que las empresas operan. En DigDev, estamos constantemente investigando y adoptando estas tendencias para ofrecer soluciones de vanguardia a nuestros clientes.',
    ...
    'en': {
        ...
        'blog.post3.title': 'Technological Trends That Will Mark 2026',
        'blog.post3.excerpt': 'We explore emerging technologies that are transforming the business digital landscape.',
        'blog.post3.content1': 'The technological landscape evolves at an accelerated pace, and 2026 promises to bring innovations that will transform the way companies operate. At DigDev, we are constantly researching and adopting these trends to offer cutting-edge solutions to our clients.',
